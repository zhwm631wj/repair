...
<html:hidden property="id"/>
    ...
    <li>
        <apcase:label styleClass="desc" key="registerApprovalForm.caseWhere"/>
    ...
    <li>
        <apcasu:label styleClass="desc" key="registerApprovalForm.rflag"/>
    ...
    <li>
        <apcasu:label styleClass="desc" key="registerApprovalForm.createDate"/>
    ...
    <li class="buttonBar bottom">
        ...
        <html:submit styleClass="button" property="method.delete" onclick="bCancel=true; return confirmDelete('RegisterApproval')">
