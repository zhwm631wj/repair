...
<html:form action="saveCheckupTransmitReturnReceipt" method="post" styleId="transmitReturnReceiptForm" onsubmit="return validateTransmitReturnReceiptForm(this)">
<ul>
