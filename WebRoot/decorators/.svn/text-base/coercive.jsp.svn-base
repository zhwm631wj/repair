...
<link rel="stylesheet" type="text/css" media="screen" href="<c:url value='/styles/displaytag.css'/>" />
...
<div id="col-left" class="nav-left-back empty resize" style="position: absolute; min-height: 450px;">
  <div class="col-left-header-tab" style="position: absolute;">强制措施</div>
  <div class="nav-left">

  </div>
      <div class="left-nav-callout png" style="top: 15px; margin-bottom: 100px;">
        <jsp:include page="/common/coerce.jsp"/>
      </div>
