 ...
 * @hibernate.class
 *         table="undertakeperson"
 *     
 */

public class UndertakePerson extends com.rosy.model.BaseObject implements java.io.Serializable {
    ...
    /** default constructor */
    public UndertakePerson() {
    }

	/** minimal constructor */
    public UndertakePerson(String regId) {
        this.regId = regId;
    }
    
    /** full constructor */
    public UndertakePerson(String regId, String userId, String remark, String rflag, Date createDate) {
        this.regId = regId;
        this.userId = userId;
        this.remark = remark;
        this.rflag = rflag;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UndertakePerson) ) return false;
		 UndertakePerson castOther = ( UndertakePerson ) other; 
