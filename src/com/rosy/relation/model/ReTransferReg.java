 ...
 * @hibernate.class
 *         table="re_transfer_reg"
 *     
 */

public class ReTransferReg extends com.rosy.model.BaseObject implements java.io.Serializable {
    ...
    /** default constructor */
    public ReTransferReg() {
    }

	/** minimal constructor */
    public ReTransferReg(String traId, String regId) {
        this.traId = traId;
        this.regId = regId;
    }
    
    /** full constructor */
    public ReTransferReg(String traId, String regId, String remark, String rflag, Date createDate) {
        this.traId = traId;
        this.regId = regId;
        this.remark = remark;
        this.rflag = rflag;
     ...
     */
     public String toString() {
      ...
      buffer.append("traId").append("='").append(getTraId()).append("' ");			
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ReTransferReg) ) return false;
		 ReTransferReg castOther = ( ReTransferReg ) other; 
         
		 return ( (this.getId()==castOther.getId()) || ( this.getId()!=null && castOther.getId()!=null && this.getId().equals(castOther.getId()) ) )
 && ( (this.getTraId()==castOther.getTraId()) || ( this.getTraId()!=null && castOther.getTraId()!=null && this.getTraId().equals(castOther.getTraId()) ) )
