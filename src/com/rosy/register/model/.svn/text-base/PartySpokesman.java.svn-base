 ...
 * @hibernate.class
 *         table="partyspokesman"
 *     
 */

public class PartySpokesman extends com.rosy.model.BaseObject implements java.io.Serializable {
    ...
    /** default constructor */
    public PartySpokesman() {
    }

    
    /** full constructor */
    public PartySpokesman(String corporatePerson, String idcard, String regIdorg, java.util.Date regDate, Integer effectPeriod, String pname, String phone, String sex, java.util.Date birthday, String married, String metier, String regAddress, String regPostalcode, String bideAddress, String bidePostalcode, String address, String remark, String rflag, java.util.Date createDate) {
        ...
        this.bidePostalcode = bidePostalcode;
    ...
    /**       
     *      *            @hibernate.property
     *             column="bidePostalcode"
     *             length="15"
     *         
     */

    public String getBidePostalcode() {
        return this.bidePostalcode;
    }
    
    public void setBidePostalcode(String bidePostalcode) {
        this.bidePostalcode = bidePostalcode;
    }
    /**       
     *      *            @hibernate.property
     ...
     */
     public String toString() {
      ...
      buffer.append("bidePostalcode").append("='").append(getBidePostalcode()).append("' ");			
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PartySpokesman) ) return false;
		 PartySpokesman castOther = ( PartySpokesman ) other; 
 ...
 && ( (this.getBidePostalcode()==castOther.getBidePostalcode()) || ( this.getBidePostalcode()!=null && castOther.getBidePostalcode()!=null && this.getBidePostalcode().equals(castOther.getBidePostalcode()) ) )
 ...
 && ( (this.getCreateDate()==castOther.getCreateDate()) || ( this.getCreateDate()!=null && castOther.getCreateDate()!=null && this.getCreateDate().equals(castOther.getCreateDate()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getBidePostalcode() == null ? 0 : this.getBidePostalcode().hashCode() );
